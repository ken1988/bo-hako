...
class Init {
  ...
  var $urlBbs		= "https://tanstaafl.tokyo/forums/";
  var $urlTopPage	= "https://tanstaafl.tokyo/";
  var $urlManual	= "https://tanstaafl.tokyo/wiki-contents/%e3%83%9e%e3%83%8b%e3%83%a5%e3%82%a2%e3%83%ab%ef%bc%88%e7%a7%bb%e6%a4%8d%e4%b8%ad%ef%bc%89/";
  var $urlHowTo		= "https://tanstaafl.tokyo/wiki-contents/2015%e5%b9%b4%e7%89%88%e7%b5%8c%e5%96%b6%e8%ac%9b%e5%ba%a7/";
  var $urlSlack		= "https://bo-hako.slack.com/";
...
"0万トン"); #弾薬
  ...
  var $disViking          =  1; # 海賊船 出現確率 船１つあたり（たくさん船を持てばその分確率UP）
  ...
  //工業消費定数
  var $Industcoms	=array(5,60,40);#原料1単位商品生産性　軽工業、重工業、先端工業（利用時は10分の1）
  var $Industmcoms	=array(5,20,10);#労働者1単位商品生産性　軽工業、重工業、先端工業（利用時は10分の1）
  var $Industfcoms  =array(1,4,1);#燃料　軽工業、重工業、先端工業

  var $SocLvMax = 201; #社会福祉最大値
  var $SocLvUpMax  = 11; #社会福祉一度に上げられる最大値
  //----------------------------------------
  // 基地の経験値
  //----------------------------------------
  // ミサイル発射禁止ターン
  ...
  //----------------------------------------
  // 通常災害発生率(確率は0.1%単位)
  var $disEarthquake = 20; // 地震
  var $disTsunami    = 4; // 津波
  var $disTyphoon    = 30; // 台風
  var $disMeteo      = 5; // 隕石
  var $disHugeMeteo  = 2;  // 巨大隕石
  var $disEruption   = 50;  // 噴火
  var $disFire       = 50; // 火災
  var $disMaizo      = 1; // 埋蔵金
  var $disHardRain   = 20; // 雨
  var $disHardRain2  = 20; // 酸性雨変化率
  var $disHardRain3  = 30; // 森増殖（深刻な被害）
  var $disResession  = 100; // 不況
  var $disRoofFall   = 1;  // 落盤
  var $disHosaku	 = 10; //豊作

  // 地盤沈下
  var $disFallBorder = 27; // 安全限界の広さ(Hex数)
  ...
  var $disMonster     = 0.8;    // 単位面積あたりの出現率(0.01%単位)
  ...
  // 専門工場の最大規模
  var $maxMFactorySize = 200; // 建材工場
  var $maxSFactorySize = 150; // 軍事工場
  ...
  function setVariable() {
	...
	$this->miningValue = array(
		$this->landStonemine	=> array(130,60),
		$this->landSteel		=> array(130,60),
		$this->landCoal			=> array(160,80),
		$this->landUranium		=> array(1100,500),
		$this->landSilver		=> array(150,70)
	);
	
	$this->mineKind = array($this->landStonemine, $this->landSteel, $this->landCoal, $this->landUranium, $this->landSilver);
